...
import ps from "../../assets/pentshirt.webp"
  ...
  return (
    <>
      ...
      <div className="flex flex-wrap">
        ...
        <div className="product-cards-container flex flex-wrap mt-16">
          <div className="fr inline-flex gap-12 pl-10">
            <img className = "w-64 h-80 " src = {ps}/>
            <img className = "w-60 h-80 " src = {ps}/>
            <img className = "w-60 h-80 " src = {ps}/>
          </div>
        </div>
      </div>
